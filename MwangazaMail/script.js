...
const WHATSAPP_PHONE_DISPLAY = "+1 682 313 2165";
const WHATSAPP_PHONE_E164 = "16823132165";
const WHATSAPP_DEFAULT_TEXT = "Hello MwangazaMail, I need support.";
const WHATSAPP_CHAT_LINK = `https://wa.me/${WHATSAPP_PHONE_E164}?text=${encodeURIComponent(WHATSAPP_DEFAULT_TEXT)}`;
const WHATSAPP_PHONE_TEL = `tel:+${WHATSAPP_PHONE_E164}`;
const WHATSAPP_QR_SRC = `https://api.qrserver.com/v1/create-qr-code/?size=240x240&margin=8&data=${encodeURIComponent(WHATSAPP_CHAT_LINK)}`;
      ...
      <main>
        <section className="hero hero-rich" id="hero">
          <div className="hero-headline">
            ...
            <div className="hero-whatsapp-connect" aria-label="Acces direct WhatsApp">
              <figure className="wa-qr-card">
                <img
                  className="wa-qr-image"
                  src=${WHATSAPP_QR_SRC}
                  alt="QR code pour ouvrir le chat WhatsApp MwangazaMail"
                  loading="lazy"
                />
                <figcaption>Scannez pour ouvrir WhatsApp instantanement</figcaption>
              </figure>
              <div className="wa-quick-links">
                <p>
                  Numero WhatsApp:
                  <a className="wa-link-inline" href=${WHATSAPP_CHAT_LINK} target="_blank" rel="noreferrer"> ${WHATSAPP_PHONE_DISPLAY}</a>
                </p>
                <p>
                  Ou tapez manuellement:
                  <a className="wa-link-inline" href=${WHATSAPP_PHONE_TEL}> ${WHATSAPP_PHONE_DISPLAY}</a>
                </p>
                <p>
                  <a className="wa-link-inline" href=${WHATSAPP_CHAT_LINK} target="_blank" rel="noreferrer">Click here</a>
                  <span> pour ouvrir le meme lien WhatsApp.</span>
                </p>
              </div>
            </div>
